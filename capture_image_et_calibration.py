...
def capture_images(name_folder, name_image):
    ic4.Library.init()
    ...
    for i in range(10):  # Capture 10 images
        try:
            ...
            # Save the image.
            image.save_as_png(f"E:\\IUT\\2e_annee\\4_semestre\\robotique_vision\\{name_folder}\\{name_image}_{i}.png")
...
def capture_images(name_folder, name_image):
    ...
    images = glob.glob(f'E:\\IUT\\2e_annee\\4_semestre\\robotique_vision\\{name_folder}\\*.png')
    ...
    img = cv.imread(f'E:\\IUT\\2e_annee\\4_semestre\\robotique_vision\\{name_folder}\\{name_image}_0.png')
    h, w = img.shape[:2]
